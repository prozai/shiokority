...
const LoginConsumer = () => {
  ...
  const [showPassword, setShowPassword] = useState(false); // Add show password functionality
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <p className="text-center mt-4">
          ...
          <button className="text-[#153247] hover:underline" onClick={() => navigate('/register-consumer')}>
            Create New Account
          </button>
        </p>
      </div>
